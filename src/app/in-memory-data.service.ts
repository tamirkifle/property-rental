    ...
    const properties: Property[] = [
      {
        ...
        listPrice: 2000,
        priceType: 'Fixed',
        postCreator: users.find(user => user.username === 'edelala'),
      ...
      },
      {
        ...
        postCreator: users.find(user => user.username === 'mahletg'),
      ...
      },
      {
        ...
        listPrice: 19000,
        priceType: 'Negotiable',
        postCreator: users.find(user => user.username === 'mesimesi'),
      ...
      },
      {
        ...
        listPrice: 29000,
        priceType: 'Fixed',
        postCreator: users.find(user => user.username === 'allhouseset'),
        propertyImages: ['assets/3.jpg', 'assets/4.jpg', 'assets/1.jpg', 'assets/2.jpg'],
        amenities: ['Backyard', 'Nice View'],
      },
    ];
